          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              <div class="controls">
                ...
                <a href="javascript:" class="mins" @click="skuNumSubtract">-</a>
              </div>
              <div class="add">
  ...
  export default {
    ...
    methods:{
      changeActive(saleAttrValue,spuSaleAttrValueList){
        spuSaleAttrValueList.forEach((attr) => {
          attr.isChecked = '0'
        });
      ...
      async addCart(){
        try{
          await this.$store.dispatch('getAddCartList',{skuId:this.$route.params.skuId, skuNum:this.skuNum})
