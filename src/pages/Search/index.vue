                ...
                <li :class="{active:isOne}" @click="changeOrder(1)">
                  <a>
                    ...
                    <span
                      v-show="isOne"
                      class="iconfont"
                      :class="{'icon-arrowBottom-fill':isDesc,'icon-arrowTop':isAsc}"
                    ></span>
                  </a>
                </li>
...
export default {
  ...
  methods: {
    ...
    attrInfo(property, attrValue) {
      let attr = `${property.attrId}:${attrValue}:${property.attrName}`;
    ...
    removeProps(event) {
      (this.searchParams.props = this.searchParams.props.filter(prop => {
        return event !== prop;
      })),
        this.getData();
    },
