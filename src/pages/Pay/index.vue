      ...
      <div class="checkout-tit">
        ...
        <div class="paymark">
          ...
          <span class="fr">
            ...
            <em class="orange money">￥{{orderPay.totalFee}}.00</em>
          </span>
        </div>
      </div>
...
export default {
  ...
  methods: {
    async orderPayInfo() {
      let result = await this.$API.reqSumbitPayOrder(this.orderId);
      if (result.code == 200) {
        this.orderPay = result.data;
      }
    },
    async open() {
      let url = await QRCode.toDataURL(this.orderPay.codeUrl)
