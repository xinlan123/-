<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail">
        <h5>商品清单</h5>
        <ul class="list clearFix" v-for="trade in tradeList.detailArrayList" :key="trade.skuId">
          <li>
            <img :src="trade.imgUrl" alt style="width:100px; height:100px" />
          </li>
          <li>
            <p>{{trade.skuName}}</p>
            <h4>7天无理由退货</h4>
    ...
    <div class="money clearFix">
      <ul>
        <li>
          <b>
            <i>{{tradeList.totalNum}}</i>件商品，总商品金额
          </b>
...
export default {
  ...
  methods: {
    changeAddress(id) {
      return this.addressInfo.forEach(address => {
        address.isDefault = 0;
        if (address.id == id) {
          address.isDefault = 1;
        }
